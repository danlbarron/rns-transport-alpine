...
You'll need to configure the reticulum config file, by setting `enable_transport = true` and locating a public gateway off of https://rmap.world or https://directory.rns.recipes.com and copying it's config to the bottom of the config file.
```shell
apk add nano
